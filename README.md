...
1.	Exploratory Data Analysis (EDA) was performed in Jupyter Notebook `diabetes-readmission.ipynb`. 
2.	Mapping categorical columns (race, gender, etc.) using OneHotEncoder.
3.	Handling missing values, merging “?” with unknown categories, removing columns with high missingness, etc.
4.	Converting readmitted to a binary label: <30 vs. Not <30.
